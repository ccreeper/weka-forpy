...
from gui.ClassifierErrorsPlotInstances import ClassifierErrorsPlotInstances
...
class ClassifierPanel(QObject):
    ...
    error_diglog_signal=pyqtSignal(str)
    ...
    def initalize(self):
        ...
        self.error_diglog_signal.connect(self.diglogError)
